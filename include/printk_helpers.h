#ifndef __PRINTK_HELPERS_H
#define __PRINTK_HELPERS_H

#include <types.h>

// 依赖: vsprintf va_list va_start va_end puts
...
static char * number(char * str, unsigned long num, unsigned long base, int size, int precision
	,int type)
{
	char c, sign, tmp[36];
